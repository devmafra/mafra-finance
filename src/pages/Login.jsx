    ...
    try {
      if (isSignUp) {
        const { error } = await supabase.auth.signUp({
          ...
          password,
          options: {
            emailRedirectTo: window.location.origin, // Garante retorno ao IP correto
            data: {
              full_name: fullName,
            },
          },
                ...
                <div className="animate-none">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none transition-all"
                      value={fullName}
